...
for c in range(0, quantidade_jogos):
    ...
    # totgols += gols #total_gols usando += em tempo de leitura

cadastro_jogador['gols_por_partida'] = lista_gols
cadastro_jogador['total_gols'] = sum(lista_gols)  # total_gols usando função sum
...
print(f'Foi um total de {cadastro_jogador["total_gols"]} gols')
